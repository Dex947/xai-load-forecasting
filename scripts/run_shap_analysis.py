...
def main():
    ...
    try:
        ...
        viz.plot_summary(
            max_display=20,
            save_path=str(FIGURES_DIR / "shap_summary.png")
        )
        ...
        viz.plot_bar(
            max_display=20,
            save_path=str(FIGURES_DIR / "shap_bar.png")
        )
        ...
        viz.plot_waterfall(
            instance_idx=0,
            save_path=str(FIGURES_DIR / "shap_waterfall_example.png")
        )
        ...
        logger.info(f"  Top 5 features explain ~{global_importance.head(5)['importance'].sum() / global_importance['importance'].sum() * 100:.1f}% of predictions")
        logger.info("\nNext steps:")
