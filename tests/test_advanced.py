...
class TestDataSourceManager:
    ...
    def test_manager_initialization(self):
        ...
        config = {"location": {"latitude": 38.7, "longitude": -9.1}, "timezone": "UTC"}
...
class TestNaturalLanguageExplainer:
    ...
    def test_explain_prediction(self):
        ...
        feature_values = pd.Series(
            {"temperature": 25.0, "load_lag_1h": 5.2, "hour": 14}
        )
        base_value = 5.0
...
class TestABTestManager:
    ...
    def test_ab_test_initialization(self):
        ...
        manager = ABTestManager(
            champion_model=champion, challenger_model=challenger, traffic_split=0.2
        )
